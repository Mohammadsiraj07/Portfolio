...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl = 'https://formsubmit.co/sirajmohammad6379@gmail.com';
      ...
      submitData.append('_subject', 'New post from Website Portfolio');
      ...
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12" >
          ...
          >
            ...
            <form 
              action="https://formsubmit.co/sirajmohammad6379@gmail.com"
              method="POST"
              className="space-y-6"
            >
              <div
              ...
              <input type="hidden" name="_subject" value="New post from Website Portfolio" />
