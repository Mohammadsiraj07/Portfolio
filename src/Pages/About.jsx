        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             I’m a Computer Science undergraduate with a strong passion for Full-Stack Development, UI/UX Design, and AI-powered solutions. I focus on creating innovative, user-friendly, and visually polished digital experiences. Whether it’s designing intuitive interfaces or building full-stack applications, I always aim to deliver high-quality results with clean code and creative thinking.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1461grlUwCDBkxnYX-EjLk1fVEcMco_2P/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
