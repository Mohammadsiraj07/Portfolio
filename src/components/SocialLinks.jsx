...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mohammad-siraj-7648692b6",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@ekizr._",
    icon: Instagram,
    url: "https://www.instagram.com/sijjubhaii?igsh=MXc5ZzdmNzRrZmhhMg==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@eki zulfar",
    icon: Youtube,
    url: "https://www.youtube.com/@Behindthebots-z7f",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@EkiZR",
    icon: Github,
    url: "https://github.com/Mohammadsiraj07",
    color: "#ffffff",
